...
Requirements: You may use any editor that you prefer. For this project you can use the JQuery
library. You may use lecture slides and the past hw’s for sample code but make sure to make it
your own.
...
To get full points add extra functionality to your map project.
Some Examples::
